...
describe('v1beta2.CloudMemcacheClient', () => {
    ...
    describe('updateInstance', () => {
        it('invokes updateInstance without error', async () => {
            ...
            request.resource ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateInstanceRequest', ['resource', 'name']);
    ...
    describe('updateParameters', () => {
        it('invokes updateParameters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateParametersRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('applyParameters', () => {
        it('invokes applyParameters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ApplyParametersRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('applySoftwareUpdate', () => {
        it('invokes applySoftwareUpdate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ApplySoftwareUpdateRequest', ['instance']);
